...
export const ui = {
  es: {
    ...
    "home.articlesWillAppear":
      "Los artículos aparecerán aquí cuando se publiquen.",

    // Blog
    "blog.archive": "Archivo",
    "blog.allArticles": "Todos los artículos publicados",
    "blog.description":
      "Todos los artículos del blog sobre Kubernetes, OpenShift, DevOps y Cloud Native.",
    ...
    "sidebar.newsletterDesc":
      "Artículos sobre Kubernetes, DevOps, IA y Cloud Native directamente en tu inbox.",
    ...
    "notes.title": "Notas",
    "notes.description":
      "Pensamientos cortos, links interesantes y posts de redes sociales.",
    "notes.note": "nota",
    "notes.notes": "notas",
    ...
    "comments.success": "Comentario enviado, pendiente de moderación",
  ...
  en: {
    ...
    "blog.description":
      "All blog articles about Kubernetes, OpenShift, DevOps and Cloud Native.",
    ...
    "sidebar.newsletter": "Newsletter",
    "sidebar.newsletterDesc":
      "Articles about Kubernetes, DevOps, AI and Cloud Native directly to your inbox.",
    ...
    "notes.title": "Notes",
    "notes.description":
      "Short thoughts, interesting links and social media posts.",
    "notes.note": "note",
    "notes.notes": "notes",
    ...
    "comments.success": "Comment submitted, pending moderation",
