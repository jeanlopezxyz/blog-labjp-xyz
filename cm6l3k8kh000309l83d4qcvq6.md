...
La gran diferencia es que, mientras antes tenías que asegurarte de que cada servidor tuviera el entorno correcto configurado (y mantenerlo actualizado), ahora simplemente ejecutas tu contenedor y listo. Es como llevar tu propia cocina portátil en lugar de depender de que cada casa tenga los utensilios que necesitas.
...
Vamos a crear un EE usando la versión 3 más reciente de ansible-builder. Esta guía está probada y funciona perfectamente con Red Hat UBI 9.
...
Con ansible-navigator (recomendado):
...
* [Ejemplos de EE en GitHub](https://github.com/ansible/ansible-builder/tree/devel/examples)
